...
function NavBar() {
  ...
  return (
<ul class="nav navbar-expand-md bg-black">
  
<FontAwesomeIcon icon="fa-brands fa-square-whatsapp"  className='h2 mt-2 pt-1 ms-3' style={{ color: 'DodgerBlue' }} />
  <li class="nav-item ">
  {/* <a class="text-white  nav-link active top-0 start-50 mt-3" aria-current="page" href="#">WhatsApp +54 (9) 2610000000</a> */}
  <a class="text-white  nav-link active top-0 start-50 mt-2" aria-current="page" href="https://api.whatsapp.com/send?phone=2617743816" target="_blank" rel='noreferrer'>WhatsApp</a>
    
  </li>
  <br/>
  <FontAwesomeIcon icon="fa-brands fa-square-instagram" className='h2 mt-2 pt-1 ms-3' style={{ color: 'DodgerBlue' }}/>
  <li class="nav-item ">
  {/* <a class="text-white  nav-link active top-0 start-50 mt-3" aria-current="page" href="#">WhatsApp +54 (9) 2610000000</a> */}
  ...
  <br/>
  <FontAwesomeIcon icon="fa-solid fa-envelope" className='h2 mt-2 pt-1 ms-3' style={{ color: 'DodgerBlue' }}/>
  <li class="nav-item ">
  {/* <a class="text-white  nav-link active top-0 start-50 mt-3" aria-current="page" href="#">WhatsApp +54 (9) 2610000000</a> */}
  <a class="text-white  nav-link active top-0 start-50 mt-2" aria-current="page" href="https://mail.google.com/mail/" target="_blank" rel='noreferrer'>Mail</a>
