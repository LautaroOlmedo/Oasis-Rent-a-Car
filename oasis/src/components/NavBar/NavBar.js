...
<FontAwesomeIcon icon="fa-brands fa-square-whatsapp"  className='h2 mt-2 pt-1 ms-3' style={{ color: 'DodgerBlue' }} />
  ...
  <br/>
  <FontAwesomeIcon icon={'fa-brands fa-instagram'} className='h2 mt-2 pt-1 ms-3' style={{ color: 'DodgerBlue' }}/>
  <li class="nav-item ">
  {/* <a class="text-white  nav-link active top-0 start-50 mt-3" aria-current="page" href="#">WhatsApp +54 (9) 2610000000</a> */}
  ...
  <li class="nav-item ">
  {/* <a class="text-white  nav-link active top-0 start-50 mt-3" aria-current="page" href="#">WhatsApp +54 (9) 2610000000</a> */}
  <a class="text-white  nav-link active top-0 start-50 mt-2" aria-current="page" href="https://mail.google.com/mail/" target="_blank" rel='noreferrer'>oasisrentacarmza@gmail.com</a>
